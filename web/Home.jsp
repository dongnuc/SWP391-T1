            ...
            <div class="page-content bg-white">
                ...
                <div class="content-block">
                    ...
                    <div class="section-area content-inner service-info-bx">
                        <div class="container">
                            <div class="row">
                                <c:forEach var="club" items="${requestScope.club}">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="service-bx">
                                        <div class="action-box">
                                            <img src="${club.getImage()}" alt="" style="height: 200px;">
                                        </div>
                                        <div class="info-bx text-center">
                                            <div class="feature-box-sm radius bg-white">
                                                <i class="fa fa-bank text-primary"></i>
                                            </div>
                                            <h4><a href="ClubDetail?id=${club.getClub()}">${club.getNameclub()}</a></h4>
                                            <a href="ClubDetail?id=${club.getClub()}" class="btn radius-xl">View More</a>
                                        </div>
                                    </div>
                                </div>
                              </c:forEach>
                    ...
                    <div class="section-area section-sp2 popular-courses-bx">
                        <div class="container">
                            ...
                            <div class="row" style="display: flex;">
                                        ...
                                        <div class="cours-bx" style="width: 270px;margin-right: 20px; ">
                                            <div class="action-box" >
                                                <img src="${blog.getImage()}" alt="" style="width: 270px;height: 170px; ">
                                                <a href="UploadContentBlog?idBlog=${blog.getIdBlog()}" class="btn">Read More</a>
                                            </div>
                                            <div class="info-bx text-center" style="height: 120px;">
                                                <h5><a href="UploadContentBlog?idBlog=${blog.getIdBlog()}">${blog.getTitleBlog()}</a></h5>
                                                <span>${blog.getNameCLub()}</span>
                                            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 text-white heading-bx left">
                                    <h2 class="title-head text-uppercase">Famous person's <span>Of FPT University</span></h2>
                                    <p>Listening to others is an important foundation for building understanding and respect in every relationship.</p>
                                </div>
                            </div>
                                ...
                                <div class="item">
                                    <div class="testimonial-bx">
                                        ...
                                        <div class="testimonial-info">
                                            <h5 class="name">Hoang Nam Tien</h5>
                                            <p>Vice Chairman of FPT University Council</p>
                                        </div>
                                        <div class="testimonial-content">
                                            <p>Success is not a destination, but a journey to become a better person and contribute to society.</p>
                                            <p>(“Thành công không phải là điểm đến, mà là chuyến hành trình để trở thành người tốt hơn và đóng góp cho xã hội.”)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="section-area section-sp2">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 heading-bx left">
                                    <h2 class="title-head">Recent <span>EVENT</span></h2>
