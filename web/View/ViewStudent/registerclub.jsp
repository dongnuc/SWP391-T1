    ...
    <body>
        ...
        <div class="page-wraper">
            ...
            <div class="page-content bg-white">
                ...
                <!-- Breadcrumb row -->
               <form method="post" action="/SWP392/registerclub" style="padding-top: 20px; padding-bottom: 20px;"> 
            ...
            <div class="form-container">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="NameClub" name="NameClub" required/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="Reason" name="Reason" rows="10" cols="50" required>
Tôi tên là: 

Sinh viên ngành: 

Tên (và loại) câu lạc bộ muốn đăng ký : 

Số thành viên hiện tại và số thành viên mong muốn trong tương lai:
...
(lưu ý: Ghi  ngắn gọn xúc tích và dưới 1000 chữ)
                    </textarea>
                    <br>
                </div>
