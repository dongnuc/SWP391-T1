        ...
        <div class="page-wraper">
            ...
            <div class="page-content bg-white">
                ...
                <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner2.jpg);">
                    <div class="container">
                        <div class="page-banner-entry">
                            <h1 class="text-white">Registration Detail</h1>
                        </div>
                    </div>
                </div>
                <!-- contact area -->
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">Registration Deatail</div>
                        <div class="card-body">
                            <form action="<%= request.getContextPath() %>/Reventdetail" method="post">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputUsername" name="ideventregister" type="hidden" value="${ideventregister}" readonly="" >

                                <div class="mb-3">
                                    <label class="small mb-1" for="inputUsername">Email</label>
                                    <input class="form-control" id="inputUsername" name="email" type="text" value="${email}" readonly="" >
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" id="inputFirstName" name="name" type="text" value="${name}">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" id="inputOrgName" name="phone" type="text" value="${phone}">
