                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="ClubProfile" method="post">
                                    ...
                                    <!-- Form Group (username)-->
                                    <div class="mb-3">
                                        <label class="small mb-1" for="inputUsername">Club Name</label>
                                        <input class="form-control" id="clubname" name="clubname" type="text"  value="${club.getNameclub()}" >
                                    </div>
                                    <!-- Form Row-->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="typeclub" class="form-control">
                                                <c:forEach items="${requestScope.listtypeclub}" var="getTypeClub"> 
                                                    <c:if test="${ club.getType() == getTypeClub.getIdTypeClub()}">
                                                        <option selected="" value="${getTypeClub.getIdTypeClub()}">${getTypeClub.getNameTypeClub()}</option>
                                                    </c:if>
                                                    <c:if test="${ club.getType() != getTypeClub.getIdTypeClub()}">
