...
<html lang="en">
    ...
    <head>
        ...
        <!-- FAVICONS ICON ============================================= -->
        <link rel="icon"  href="../../images_t/favicon.ico" type="image/x-icon" />
        <link rel="shortcut icon" type="image/x-icon"  href="../../images_t/favicon.png" />
        ...
        <!--[if lt IE 9]>
        <script src="../../js_t/html5shiv.min.js"></script>
        <script src="../../js_t/respond.min.js"></script>
        <![endif]-->

        <!-- All PLUGINS CSS ============================================= -->
        <link rel="stylesheet" type="text/css" href="../../css_t/assets.css">

        <!-- TYPOGRAPHY ============================================= -->
        <link rel="stylesheet" type="text/css" href="../../css_t/typography.css">

        <!-- SHORTCODES ============================================= -->
        <link rel="stylesheet" type="text/css" href="../../css_t/shortcodes/shortcodes.css">

        <!-- STYLESHEETS ============================================= -->
        <link rel="stylesheet" type="text/css" href="../../css_t/style.css">
        <link class="skin" rel="stylesheet" type="text/css" href="../../css_t/color/color-1.css">
    ...
    <body id="bg">
        <div class="page-wraper">
                ...
                <div class="sticky-header navbar-expand-lg">
                    <div class="menu-bar clearfix">
                        <div class="container clearfix">
                            <!-- Header Logo ==== -->
                            <div class="menu-logo">
                                <a href="index.html"><img src="../../images_t/logo.png" alt=""></a>
                            </div>
                            <!-- Mobile Nav Button ==== -->
                            ...
                            <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                                ...
                                <ul class="nav navbar-nav">	
                                    ...
                                    <li class="add-mega-menu"><a href="javascript:;">Our Courses <i class="fa fa-chevron-down"></i></a>
                                        <ul class="sub-menu add-menu">
                                            ...
                                            <li class="add-menu-right">
                                                <img src="../../images_t/adv/adv.jpg" alt=""/>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a href="javascript:;">Blog <i class="fa fa-chevron-down"></i></a>
                                        ...
                                        %>
                                        <ul class="sub-menu">
                                            <li><a href="blog-classic-grid.html"><%= blogType.getNameBlogType()%></a></li>
            ...
            <div class="page-content bg-white">
                <!-- inner page banner -->
                <div class="page-banner ovbl-dark" style="background-image:url(../../images_t/banner/banner2.jpg);">
                    <div class="container">
                                ...
                                <div class="col-lg-4 sticky-top">
                                    <aside class="side-bar sticky-top">
                                        ...
                                        <div class="widget recent-posts-entry">
                                            ...
                                            <div class="widget-post-bx">
                                                <div class="widget-post clearfix">
                                                    <div class="ttr-post-media"> <img src="../../images_t/blog/recent-blog/pic1.jpg" width="200" height="143" alt=""> </div>
                                                    <div class="ttr-post-info">
                                                ...
                                                <div class="widget-post clearfix">
                                                    <div class="ttr-post-media"> <img src="../../images_t/blog/recent-blog/pic2.jpg" width="200" height="160" alt=""> </div>
                                                    <div class="ttr-post-info">
                                                        <div class="ttr-post-header">
                                                ...
                                                <div class="widget-post clearfix">
                                                    <div class="ttr-post-media"> <img src="../../images_t/blog/recent-blog/pic3.jpg" width="200" height="160" alt=""> </div>
                                                    <div class="ttr-post-info">
                                                        <div class="ttr-post-header">
                                        ...
                                        <div class="widget widget_gallery gallery-grid-4">
                                            ...
                                            <ul>
                                                <li><div><a href="#"><img src="../../images_t/gallery/pic2.jpg" alt=""></a></div></li>
                                                <li><div><a href="#"><img src="../../images_t/gallery/pic1.jpg" alt=""></a></div></li>
                                                <li><div><a href="#"><img src="../../images_t/gallery/pic5.jpg" alt=""></a></div></li>
                                                <li><div><a href="#"><img src="../../images_t/gallery/pic7.jpg" alt=""></a></div></li>
                                                <li><div><a href="#"><img src="../../images_t/gallery/pic8.jpg" alt=""></a></div></li>
                                                <li><div><a href="#"><img src="../../images_t/gallery/pic9.jpg" alt=""></a></div></li>
                                                <li><div><a href="#"><img src="../../images_t/gallery/pic3.jpg" alt=""></a></div></li>
                                                <li><div><a href="#"><img src="../../images_t/gallery/pic4.jpg" alt=""></a></div></li>
                                            </ul>
                                        </div>
                        ...
                        <div class="container">
                            <div class="d-flex align-items-stretch">
                                <div class="pt-logo mr-auto">
                                    <a href="index.html"><img src="../../images_t/logo-white.png" alt=""/></a>
                                </div>
                            ...
                            <div class="col-12 col-lg-3 col-md-5 col-sm-12 footer-col-4">
                                <div class="widget widget_gallery gallery-grid-4">
                                    ...
                                    <ul class="magnific-image">
                                        <li><a  href="../../images_t/gallery/pic1.jpg" class="magnific-anchor"><img src="../../images_t/gallery/pic1.jpg" alt=""></a></li>
                                        <li><a  href="../../images_t/gallery/pic2.jpg" class="magnific-anchor"><img src="../../images_t/gallery/pic2.jpg" alt=""></a></li>
                                        <li><a  href="../../images_t/gallery/pic3.jpg" class="magnific-anchor"><img src="../../images_t/gallery/pic3.jpg" alt=""></a></li>
                                        <li><a  href="../../images_t/gallery/pic4.jpg" class="magnific-anchor"><img src="../../images_t/gallery/pic4.jpg" alt=""></a></li>
                                        <li><a  href="../../images_t/gallery/pic5.jpg" class="magnific-anchor"><img src="../../images_t/gallery/pic5.jpg" alt=""></a></li>
                                        <li><a  href="../../images_t/gallery/pic6.jpg" class="magnific-anchor"><img src="../../images_t/gallery/pic6.jpg" alt=""></a></li>
                                        <li><a  href="../../images_t/gallery/pic7.jpg" class="magnific-anchor"><img src="../../images_t/gallery/pic7.jpg" alt=""></a></li>
                                        <li><a  href="../../images_t/gallery/pic8.jpg" class="magnific-anchor"><img src="../../images_t/gallery/pic8.jpg" alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <script src="../../js_t/jquery.min.js"></script>
        ...
        <script src="../../js_t/functions.js"></script>
        <script src="../../js_t/contact.js"></script>
