			...
			<div class="ttr-logo-box">
				<div>
					<a href="index.html" class="ttr-logo">
						<img class="ttr-logo-mobile" alt="" src="${pageContext.request.contextPath}/assets_admin/images/logo-mobile.png" width="30" height="30">
						<img class="ttr-logo-desktop" alt="" src="${pageContext.request.contextPath}/assets_admin/images/logo-white.png" width="160" height="27">
					</a>
				</div>
			</div>
			<!--logo end -->
						...
						<div class="widget-inner">
							<div class="new-user-list">
								<ul>
									...
									<li>
										<span class="new-users-pic">
											<img src="${pageContext.request.contextPath}/assets_admin/images/testimonials/pic2.jpg" alt=""/>
										</span>
										<span class="new-users-text">
									...
									<li>
										<span class="new-users-pic">
											<img src="${pageContext.request.contextPath}/assets_admin/images/testimonials/pic3.jpg" alt=""/>
										</span>
										<span class="new-users-text">
