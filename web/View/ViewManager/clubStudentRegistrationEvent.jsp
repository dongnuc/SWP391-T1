<%-- 
    Document   : clubStudentRegistrationEvent
    Created on : Jul 13, 2024, 11:49:10 PM
    Author     : Nguyen Hau
--%>
                                ...
                                <form class="edit-profile m-b30" action="${pageContext.request.contextPath}/EventUploadServlet" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <textarea class="form-control expandable-textarea" name="description">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div id="editor">
                                                <textarea class="form-control" name="content">
                                                    ...
                                                    Student Recruitment Event: <a href="ClubStudentRegistrationServle?id=${param.id}">Link to Registration Page</a>
                                        ...
                                        <div class="form-group col-4">
                                            ...
                                            <div>
                                                <input type="radio" name="idclub" value="${requestScope.idclub}" > ${clubDAO.getClubNameByID(idclub)}
                                            </div>
                                        ...
                                        <div class="form-group col-4">
                                            ...
                                            <div>
                                                <input type="radio" name="eventtype" value="18" ${param.eventtype == eventType.idSetting ? 'checked' : ''}>Competitions and Contests
                                            </div>
