                        ...
                        <div class="form-title">
                            ...
                            <div class="name-group">
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" id="firstName" class="input-field" placeholder="Nguyen Duc Hau" />
                                </div>
                                <div class="input-wrapper">
                                    <label for="email">Email</label>
                                    <input type="email" id="email" class="input-field" placeholder="haundhe176911@fpt.edu.vn" />
                                </div>
                            </div>
                            <div class="input-container">
                                <div class="input-wrapper">
                                    <label for="lastName">Tittle</label>
                                    <input type="text" id="lastName" class="input-field" placeholder="Don xin vao CLB bao gio duoc duyet" />
                                </div>
                            </div>
                            <label class="message-label" for="message"></label>
                            <textarea id="message" class="message-field" placeholder="Write your message.." rows="5"></textarea>
