 ...
 * @author Nguyen Hau
 */
@WebServlet(name="SelectStudentbyPositionServlet", urlPatterns={"/SelectStudentbyPositionServlet"})
public class SelectStudentbyPositionServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SelectStudentbyPositionServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SelectStudentbyPositionServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
       ...
       String page = request.getParameter("page");
        ...
        StudentClubDAO stdao = new StudentClubDAO();
         if(request.getParameter("id")!=null&&request.getParameter("leader")!=null){
             ...
             List<StudentClub> list = stdao.getTenStudentClubbyleader(id, leader, pageNumber);
