...
@WebServlet(name="EventClubStudentRegistrationServlet", urlPatterns={"/EventClubStudentRegistrationServlet"})
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
        maxFileSize = 1024 * 1024 * 10, // 10MB
        maxRequestSize = 1024 * 1024 * 50)   // 50MB
public class EventClubStudentRegistrationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("idclub", Integer.parseInt(request.getParameter("id")));
        request.getRequestDispatcher("/View/ViewManager/clubStudentRegistrationEvent.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fileName != null) {
            ...
            response.sendRedirect("/EventSerlet");
        } else {
