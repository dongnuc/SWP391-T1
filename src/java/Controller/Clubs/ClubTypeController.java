...
public class ClubTypeController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Clubs> listclub = dao.getNineClubsbyIDtypeclub(pageNumber,id);
        ...
        request.setAttribute("numberOfPage", (int) Math.ceil(dao.getNumberOfClubbyID(id) * 1.0 / 9));
        }
